...
public class PrisonPoliceConfig {
	...
	public PrisonPoliceConfig(PrisonPolice plugin) {
		...
		String[] consolecommands = { "econ add <policeman> 500",
				"pex user <criminal> group set default" };
		...
		plugin.getConfig().addDefault("illegalblocks",
				Arrays.asList(illegalblocks));
		plugin.getConfig().addDefault("blocksname", illegalblocksname);
		plugin.getConfig().addDefault("jail.commands.console",
				Arrays.asList(consolecommands));
		plugin.getConfig().addDefault("jail.commands.policeman",
				Arrays.asList(policemancommands));
		plugin.getConfig().addDefault("jail.commands.criminal",
				Arrays.asList(criminalcommands));
